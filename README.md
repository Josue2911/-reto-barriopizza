...
La parte del diseño lo cree yo inspirándome en el diseño de la pagina de Barrio pizza, intente que se tuviera un estilo parecido para eso utilice el framework Taildwind, por comodidad mas que todo, La carga de datos, los cálculos y el render de los avisos lo hice con JavaScript, para esto ultimo si utilice la IAs de ChatGPT y ClaudeAI como apoyo para guiarme y corregir errores en el código.


## La lógica principal del código

Para esto cree varias funciones diferentes para mantener un orden en el código y que este fuera mas leíble.
